...
const MIDNIGHTS_DARK = '#1F2E43';   // dark
const MIDNIGHTS_LIGHT = '#E0EDFD';  // light
...
const RankingMidnightsPage: React.FC = () => {
  ...
  const renderTrackList = () => {
    if (isLoading) {
      return <div style={{ textAlign: 'center', padding: 40, color: MIDNIGHTS_DARK }}>Carregando a lista de músicas do Speak Now...</div>;
    }
